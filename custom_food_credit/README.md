...
3. Aller à l’onglet **Credit** (oui, orthographe telle quelle dans l’écran)
...
1. Ouvrir **Contacts → Contacts**
2. Sur le client concerné, onglet **Credit**
...
- [CAPTURE] Contact société : onglet “Credit” → bloc “Credit Alimentaire”
